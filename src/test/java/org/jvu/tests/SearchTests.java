...
public class SearchTests extends BaseTest{
    @Test(description = "user should see matching search results for an item/keyword searched")
    ...
    @Test(description = "search should not return any results if search term is not alphanumerical")

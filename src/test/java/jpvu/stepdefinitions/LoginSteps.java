...
public class LoginSteps {
    ...
    public void iNavigateToLoginPage() {
        HomePage hp = new HomePage(CucumberHooks.getCucumberDriver());
        hp.clickLoginBtn();
    }

    @When("^user enters username and password$")
    public void iEnterUsernameAndPassword() {
        LoginPage lp = new LoginPage(CucumberHooks.getCucumberDriver());
    ...
    public void iAmLoggedIn() {
        AccountPage ap = new AccountPage(CucumberHooks.getCucumberDriver());

        Assert.assertTrue(ap.hdrMyAccount.isDisplayed());
        Assert.assertEquals(CucumberHooks.getCucumberDriver().getCurrentUrl(), "https://automationteststore.com/index.php?rt=account/account");
    }
    ...
    public void iAmNotLoggedIn() {
        ...
        Assert.assertEquals(CucumberHooks.getCucumberDriver().getCurrentUrl(), "https://automationteststore.com/index.php?rt=account/login");
    }
